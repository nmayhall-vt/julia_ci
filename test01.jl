...
ConfigStrings.print(ket_a)
ConfigStrings.apply_annihilation!(ket_a,7)
ConfigStrings.calc_max!(ket_a)
ConfigStrings.calc_linear_index!(ket_a)
ConfigStrings.print(ket_a)
@assert(ket_a.config == [1, 2, 3, 4, 6, 8])
@assert(ket_a.sign == -1)
@assert(ket_a.max == 210)
@assert(ket_a.lin_index == 7)

print("a\n")
ConfigStrings.print(ket_a)
ConfigStrings.apply_creation!(ket_a,7)
ConfigStrings.calc_linear_index!(ket_a)
ConfigStrings.calc_max!(ket_a)
ConfigStrings.print(ket_a)
@assert(ket_a.config == [1, 2, 3, 4, 6, 7, 8])
print("b\n")
@assert(ket_a.sign == 1)
@assert(ket_a.max == 120)
@assert(ket_a.lin_index == 11)

ConfigStrings.apply_creation!(ket_a,9)
ConfigStrings.calc_linear_index!(ket_a)
ConfigStrings.calc_max!(ket_a)
ConfigStrings.print(ket_a)
@assert(ket_a.config == [1, 2, 3, 4, 6, 7, 8, 9])
@assert(ket_a.sign == -1)
@assert(ket_a.max == 45)
@assert(ket_a.lin_index == 11)
